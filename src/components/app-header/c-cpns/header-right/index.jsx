...
const HeaderRight = memo(() => {
  ...
  return (
    <RightWrapper>
      <div className='btns'>
        <span onClick={onLoginClick}>登陆</span>
      ...
      <div className='profile' >
        <div className='profile-c'  onClick={onProfileClick}>
        ...
        </div>
         {
          ...
          <div className='panel'>
            <div className='top'>
              <div className='item' onClick={onRegisteClick}>注册</div>
              <div className='item' onClick={onLoginClick}>登陆</div>
            </div>
            <div className="bottom">
              <div className='item' onClick={onRentHouseClick}>出租房源</div>
              <div className='item' onClick={onExperienceClick}>开展体验</div>
              <div className='item' onClick={onHelpClick}>帮助</div>
            </div>
          </div>
         }
