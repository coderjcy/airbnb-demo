    ...
    <DetailWrapper>
      <div className="outer">
        <div className="pictures">
          <div className="left-a pic-wrapper">
            <img className="img" src={detailInfo.picture_urls[0]} alt="" />
            <div className="pic-cover"></div>
          </div>
          <div className="right-a">
            {detailInfo.picture_urls.slice(1, 5).map((v) => (
              <div key={v} className="pic-wrapper">
                <img className="img" src={v} alt="" />
                <div className="pic-cover"></div>
              </div>
            ))}
          </div>
        </div>
        <button className="btn" onClick={onViewPicClick}>
          查看照片
        </button>
      </div>
    </DetailWrapper>
